...
if __name__ == "__main__":
    json_file_path = "/home/tanxiaobing/IR_Rainbow/questions_adversarial_panwei.json"
    # json_file_path = "/home/tanxiaobing/IR_Rainbow/questions_adversarial_saas.json"
    ...
    # 连接到已存在的向量存储
    vectorstore = libMgmt.connect_to_existing_vectorstore(es_conn_args, index_name, embed_model_name_or_path, device)
