...
RERANKER_MODEL_PATH = f"{model_base_dir}/checkpoint-300" 
...
ES_URI = "http://nginx-gzywzczx-svc.ai-org-dev:95"

ES_CONN_ARGS = {
    "es_url": ES_URI,
    # 如果ES需要认证，可以添加 es_user 和 es_password
    "es_user": "elastic",
    "es_password": "QYAxjidBym8xQWW6FbJx"
}